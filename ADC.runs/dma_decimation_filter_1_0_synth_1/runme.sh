...
HD_PWD='C:/Projects/ERN24004/Projects/ADC/ADC.runs/dma_decimation_filter_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_decimation_filter_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_decimation_filter_1_0.tcl
