...
HD_PWD='C:/Projects/ERN24004/Projects/ADC/ADC.runs/dma_filter_ctrl_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_filter_ctrl_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_filter_ctrl_0_2.tcl
