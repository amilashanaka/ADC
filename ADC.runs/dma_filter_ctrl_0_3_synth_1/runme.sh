...
HD_PWD='C:/Projects/ERN24004/Projects/ADC/ADC.runs/dma_filter_ctrl_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_filter_ctrl_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_filter_ctrl_0_3.tcl
