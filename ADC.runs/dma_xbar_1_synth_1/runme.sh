...
HD_PWD='C:/Projects/ERN24004/Projects/ADC/ADC.runs/dma_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_xbar_1.tcl
